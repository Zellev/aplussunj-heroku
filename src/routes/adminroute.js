...
let router = express.Router({mergeParams:true});
    ...
    router.put('/users/:id_user(?!bulk)', AdminControl.putUser);
    router.put('/users/bulk', uploadExcel.single('fileupdater'), AdminControl.putUserbulk);
    router.patch('/user/:id_user/reset-pw', AdminControl.patchUserPw);
    router.delete('/users/:id_user', AdminControl.deleteUser);
    ...
    router.put('/dosen/bulk', uploadExcel.single('fileupdater'), AdminControl.putDosenbulk);
    ...
    router.put('/mahasiswa/bulk', uploadExcel.single('fileupdater'), AdminControl.putMhsbulk);
    ...
    router.put('/matakuliah/:id_matkul', AdminControl.putMatkul);
    router.put('/matakuliah/bulk', uploadExcel.single('fileupdater'), AdminControl.putMatkulbulk);
    ...
    router.put('/kelas/bulk', uploadExcel.single('fileupdater'), AdminControl.putKelasbulk);
    ...
    router.post('/kelas/:id_kelas/mhs', uploadExcel.single('fileadder'), AdminControl.kelasSetMhs);
    router.put('/kelas/:id_kelas/mhs', uploadExcel.single('fileupdater'), AdminControl.kelasUpdateMhs);
